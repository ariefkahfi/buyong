          ...
          <section class="col-lg-12">
            ...
            <div class="box">
              ...
              <div class="box-body chat" id="chat-box">
                ...
                <div class="form-group">
                  <button type="submit" class="btn btn-primary data-toggle="tooltip" data-placement="left" title="Simpan perubahan ">Simpan</button>
                  <a href="<?php echo base_url(); ?>karyawan" class="btn btn-warning data-toggle="tooltip" data-placement="left" title="Kembali kehalaman Karyawan"> Kembali</a>
                </div><!-- /.col -->
               </form>
